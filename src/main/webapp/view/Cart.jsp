                    ...
                    <c:forEach items="${cart}" var="item" varStatus="status">
                        <tr style="height: 100px">
                            <form action="" style="height: 1000px">
                                ...
                                <td>
                                    <label>${item.price * item.quantity} đ</label>
                                </td>
                                <td>
...
<div style="display: flex;width: 90%;text-align: center;margin-top: 110px;margin-left: 100px">
    <form action="">
        <input style="width: 25px;height: 15px" type="checkbox" value=""> Chọn tất cả
    </form>
    <form style="margin-top: 1px;height: 30px;display: flex" action="">
        <label style="width: 100px;margin-left: 30px">Tổng tiền </label>
        <button style="margin-left: 700px ;margin-top: -10px; text-align: center" type="submit">Thanh toán</button>
    </form>
</div>
